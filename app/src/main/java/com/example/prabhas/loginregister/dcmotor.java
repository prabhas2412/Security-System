...
/**
 * Created by PRABHAS on 12/21/2016.
 */
...
public class dcmotor extends Activity {
    private static final String TAG = "DC MOTOR";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcmotor);

        btnOn1 = (Button) findViewById(R.id.btnOn1);
        btnOff1 = (Button) findViewById(R.id.btnOff1);
       lock_state_img1 = (ImageView) findViewById(R.id.lock_state_img1);
        ...
        btnOn1.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                sendData("2");
                lock_state_img1.setImageResource(R.drawable.mv);
        ...
        btnOff1.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                sendData("3");
                lock_state_img1.setImageResource(R.drawable.st);
